...
const PrintPageHM: React.FC<Props> = ({
  onClose,
  isOpen,
  componentRef,
  data,
      ...
      <div style={{ width: "40%", borderRight: "solid gray 1px" }}>
        <div style={{ borderBottom: "solid gray 1px" }}>
          ...
          <div style={{ fontSize: "10px", padding: "5px" }}>
            {electronicSupport.map((item, x) => (
              <TickComponent
                key={x}
                tick={
                  category?.name === "Electronic Support"
            ...
            <div style={{ fontSize: "11px", paddingLeft: "5px" }}>
              {ElectronicsSupport.map((item, x) => (
                <TickComponent
                  key={x}
                  tick={
                    category?.name === "Electronics Support"
                      ? subCategories?.some((sub) => {
                          if (item === sub.name) return true;
                          return false;
                        })
