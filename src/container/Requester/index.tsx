  ...
  return (
    ...
    <React.Fragment>
      <Flex w="full" flexDirection="column">
        ...
        <SubHeadingComponent screenPadding={screenPadding} />
      ...
      {isOpen && (
        <DrawerTicket formData={formStateHolder ? formStateHolder : null} isOpen={isOpen} onClose={onClose} />
      )}

      {isModalOpen && (
        <ModalView rowId={selectedRow} isOpen={isModalOpen} onClose={closeModal} />
      )}
    </React.Fragment>
  );
};
